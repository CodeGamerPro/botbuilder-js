...
describe('LuisRecognizer', function () {
    ...
    it('should return an intent and prebuilt entities with a single value', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance.entities['builtin.number'].resolution);
                assert(res[0].$instance.entities['builtin.number'].resolution === '2001');
                ...
                assert(res[0].$instance.entities['builtin.datetimeV2.date'].resolution);
                assert(res[0].$instance.entities['builtin.datetimeV2.date'].resolution.timex);
    ...
    it('should return an intent and a list entity with a single value', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance.entities.Airline.resolution);
                assert(res[0].$instance.entities.Airline.resolution === 'United');
                done();
            });
    });
    ...
    it('should return an intent and a list entity with multiple values', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance.entities.Airline.resolution);
                assert(res[0].$instance.entities.Airline.resolution.length === 2);
                assert(res[0].$instance.entities.Airline.resolution.indexOf('Delta') > -1);
                assert(res[0].$instance.entities.Airline.resolution.indexOf('Virgin') > -1);
                done();
            });
    });
    ...
    it('should return an intent and a single composite entity', function(done){
        ...
        recognizer.recognize(context).then(res => {
                ...
                assert(res[0].$instance.entities['builtin.number'].resolution);
                assert(res[0].$instance.entities['builtin.number'].resolution === "98033");
                ...
                assert(res[0].$instance.entities.Address['builtin.number'].resolution);
                assert(res[0].$instance.entities.Address['builtin.number'].resolution === "98033");
